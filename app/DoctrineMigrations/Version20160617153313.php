 ...
 */
class Version20160617153313 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE ra_location (ra_location_id VARCHAR(36) NOT NULL, institution LONGTEXT NOT NULL, ra_location_name VARCHAR(255) NOT NULL, location LONGTEXT NOT NULL, contact_information LONGTEXT NOT NULL, INDEX idx_ra_location_institution (institution), PRIMARY KEY(ra_location_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ra_second_factor ADD document_number VARCHAR(255) NOT NULL, CHANGE institution institution VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE status status INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE event_stream (uuid VARCHAR(36) NOT NULL COLLATE utf8_unicode_ci, playhead INT NOT NULL, metadata TEXT NOT NULL COLLATE utf8_unicode_ci, payload LONGTEXT NOT NULL COLLATE utf8_unicode_ci, recorded_on VARCHAR(32) NOT NULL COLLATE utf8_unicode_ci, type VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci, INDEX type (type), PRIMARY KEY(uuid, playhead)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_stream_sensitive_data (identity_id VARCHAR(36) NOT NULL COLLATE utf8_unicode_ci, playhead INT NOT NULL, sensitive_data LONGTEXT NOT NULL COLLATE utf8_unicode_ci, PRIMARY KEY(identity_id, playhead)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ra_second_factor DROP document_number, CHANGE institution institution VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE name name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE email email VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE status status INT NOT NULL');
