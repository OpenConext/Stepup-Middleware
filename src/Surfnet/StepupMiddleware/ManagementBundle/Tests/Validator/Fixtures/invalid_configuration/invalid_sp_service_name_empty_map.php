        ...
        'gateway' => [
            ...
            'service_providers' => [
                [
                    ...
                    // An empty map is rejected: Gateway treats {} as "not configured" and
                    // falls through to the SP-supplied name, which is not what an
                    // administrator writing {} intends. Omit the property instead.
                    "service_name" => [],
                ],
            ],
        ],
